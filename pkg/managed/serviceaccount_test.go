...
func TestCreateVMIServiceAccounts(t *testing.T) {
	...
	assert.Equal(4, len(serviceAccounts), "4 service accounts were expected for cluster local")
	...
	assert.Equal(4, len(serviceAccounts), "4 service accounts were expected for cluster cluster-1")
